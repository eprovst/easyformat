...
\begin{document}
	...
	\pkg{easyformat} sometimes conflicts with the loading of other packages (eg. \pkg{babel}, \pkg{fontspec} and \pkg{microtype}). This is fixed by importing \pkg{easyformat} after those packages.
