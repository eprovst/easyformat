...
\title{\pkg{easyformat}\\[.5em]
		\large _the_ manual for the 2017/05/31 version (v1.3.1)}
...
\begin{document}
	...
	\subsection*{2017/05/31 v1.3.1}
	Further improved code readability and extended usage of \pkg{expl3} capabilities.
